          ...
          <div className="mx-auto flex min-h-[74vh] w-full max-w-7xl items-center px-4 py-14 sm:px-6 sm:py-20 lg:min-h-[80vh] lg:py-24">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-base leading-relaxed text-white/90 sm:text-xl/relaxed">
                Private, structured feedback on your performance, voice, setup and brief fit before
                your tape reaches casting. Performer reviews can be funded by your school or coach,
                with optional self-serve top-ups where enabled.
              </p>
              ...
              <p className="mt-6 flex max-w-lg items-start gap-2 text-sm leading-relaxed text-sidebar-foreground/75">
                ...
                <span>
                  Private by default. No public posting. Clear notes for performers, coaches and
                  schools before submission.
                </span>
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-start lg:gap-16">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                {[
                  ...
                  {
                    icon: ShieldCheck,
                    title: "Can my coach or school review this with me?",
                    body: "Partner-funded reviews make it easier to keep feedback inside training, coaching and submission prep.",
                  },
                ].map((item) => (
        ...
        <section className="border-y border-border bg-secondary/40 py-14 sm:py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-relaxed text-muted-foreground sm:text-base">
              The performer-facing report stays the product. Partner funding changes who can unlock a
              review, not the depth of the notes the performer receives.
            </p>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.6fr] lg:items-start lg:gap-14">
              <div className="lg:pt-4">
                ...
                <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                  ...
                  practical next steps, whether the review was unlocked directly or through a school
                  or coach partner.
                </p>
                <div className="mt-8">
              ...
              <div>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    {
                      icon: Users,
                      title: "Feedback supports your choices, not your budget.",
                    },
                    {
                      icon: ShieldCheck,
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-5 rounded-t-md border border-b-0 border-border bg-card px-6 py-7 shadow-soft sm:flex-row sm:items-center sm:px-10">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Give yourself the best chance of sending a stronger tape, whether you review solo or
                through a school or coach.
              </p>
            </div>
