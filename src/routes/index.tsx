          ...
          <div className="mx-auto flex min-h-[74vh] w-full max-w-7xl items-center px-4 py-14 sm:px-6 sm:py-20 lg:min-h-[80vh] lg:py-24">
            <div className="min-w-0 max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-base leading-relaxed text-white/90 sm:text-xl/relaxed">
                Private, structured feedback on performance, voice, setup and brief fit. Use a free
                report to catch avoidable issues before upload.
              </p>

              <div className="mt-9 flex flex-wrap items-center gap-3">
                <Button asChild size="lg" className="px-7">
                  <Link to="/login">
                    {LAUNCH_PRIMARY_CTA} <ArrowRight className="ml-1 h-4 w-4" />
                  </Link>
                </Button>
                <Button
                  asChild
                ...
                >
                  <Link to="/b2b-interest">{LAUNCH_B2B_CTA}</Link>
                </Button>
              </div>
              ...
              <p className="mt-6 flex max-w-lg items-start gap-2 text-sm leading-relaxed text-sidebar-foreground/75">
                ...
                <span>
                  Private by default. No public posting. No casting promises. Just clear notes
                  before you submit.
                </span>
              </p>
            </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-start lg:gap-16">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                {[
                  ...
                  {
                    icon: ShieldCheck,
                    title: "Am I sending the clearest version of this take?",
              ...
              <div className="lg:pt-4">
                ...
                <div className="mt-8">
                  <Button asChild variant="outline">
                    <Link to="/example-report">See full example</Link>
                  </Button>
                </div>
              </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-start lg:gap-14">
              ...
              <div className="space-y-3">
                {LAUNCH_TRUST_ASSETS.map((item) => (
                  ...
                  >
                    <h3 className="font-display text-base font-bold text-sidebar-foreground">
                      {item.title}
                    </h3>
                ...
                >
                  <Link to="/trust">Read trust notes</Link>
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
              <div>
                ...
                <h2 className="mt-3 max-w-2xl font-display text-3xl font-bold tracking-tight sm:text-4xl">
                  Fund useful report credits without opening unlimited usage.
                </h2>
              ...
              <Button asChild size="lg">
                <Link to="/b2b-interest">
                  {LAUNCH_B2B_CTA} <ArrowRight className="h-4 w-4" />
                </Link>
              </Button>
            </div>
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-5 rounded-t-md border border-b-0 border-border bg-card px-6 py-7 shadow-soft sm:flex-row sm:items-center sm:px-10">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Get a private sanity check on the tape and the task.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button asChild size="lg" variant="ghost">
                <Link to="/demo">
                  Demo video <PlayCircle className="h-4 w-4" />
                </Link>
              </Button>
            </div>
          </div>
