...
const RUNTIME_EVIDENCE_SPINE_AUDIT_MAP: ReadonlyArray<RuntimeEvidenceSpineAuditItem> = [
  ...
  { artefact_id: 'validator_trace', category: 'analysis_take', expected_path: 'traces/validator_trace.json', current_source_module: 'required list only', expected_source_of_truth: 'validation / UK / leakage gate chain', current_manifest_status: 'emitted', source_classification: 'internal_validator', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', blocker_code: 'ValidatorTrace_internal_only', next_implementation_step: 'promote only when independent runtime v3 validation/proof chain exists' },
  { artefact_id: 'gate_trace', category: 'analysis_take', expected_path: 'traces/gate_trace.json', current_source_module: 'required list only', expected_source_of_truth: 'gate status computation', current_manifest_status: 'emitted', source_classification: 'internal_gate_trace', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', blocker_code: 'GateTrace_internal_only', next_implementation_step: 'promote only when independent runtime v3 gate/proof chain exists' },
