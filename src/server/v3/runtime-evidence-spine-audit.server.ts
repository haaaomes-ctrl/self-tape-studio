...
const RUNTIME_EVIDENCE_SPINE_AUDIT_MAP: ReadonlyArray<RuntimeEvidenceSpineAuditItem> = [
  ...
  { artefact_id: 'qa_acceptance_metrics', category: 'analysis_take', expected_path: 'qa/acceptance_metrics.json', current_source_module: 'qa-artifacts.server + qa-artifacts-wiring.server', expected_source_of_truth: 'qa/acceptance_metrics.json', current_manifest_status: 'emitted', source_classification: 'runtime_v3', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Validate against real Storage sink evidence in operator environment' },
