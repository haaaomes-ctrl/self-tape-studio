...
const RUNTIME_EVIDENCE_SPINE_AUDIT_MAP: ReadonlyArray<RuntimeEvidenceSpineAuditItem> = [
  ...
  { artefact_id: 'step1_observable_evidence', category: 'analysis_take', expected_path: 'analysis/Step1ObservableEvidence.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitAnalysisEvidenceStatePrerequisite', expected_source_of_truth: 'internal Step 1 observable evidence container fed by deterministic runtime facts and future extractors', current_manifest_status: 'emitted', source_classification: 'real_runtime_v3_partial', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', blocker_code: 'Step1ObservableEvidence_partial', next_implementation_step: 'Implement real video/audio/material/performance/candidate-technique extractors and truth linkage before treating this as satisfying evidence' },
  ...
  { artefact_id: 'qa_acceptance_metrics', category: 'analysis_take', expected_path: 'qa/acceptance_metrics.json', current_source_module: 'qa-artifacts.server + qa-artifacts-wiring.server', expected_source_of_truth: 'reconciliation summary over emitted evidence artefacts; not a satisfying evidence source by itself', current_manifest_status: 'emitted', source_classification: 'real_runtime_v3', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep as metrics/global reason reconciliation and validate against source artefacts; do not count metrics emission alone as evidence satisfaction' },
  { artefact_id: 'comparison_raw', category: 'comparison', expected_path: 'comparison/comparison.raw.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitComparisonRuntimeArtifacts', expected_source_of_truth: 'real comparison runtime execution', current_manifest_status: 'missing', source_classification: 'internal_comparison_runtime', runtime_data_available_now: 'unknown', can_emit_without_invention: false, required_for_level: 'L2', blocker_code: 'ComparisonRuntime_internal_only', next_implementation_step: 'Wire real upstream comparison runtime producer into QA emitter and independently validate proof chain' },
  { artefact_id: 'comparison_report_internal', category: 'comparison', expected_path: 'comparison/comparison.report.internal.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitComparisonRuntimeArtifacts', expected_source_of_truth: 'real comparison runtime execution', current_manifest_status: 'missing', source_classification: 'internal_comparison_report', runtime_data_available_now: 'unknown', can_emit_without_invention: false, required_for_level: 'L2', blocker_code: 'ComparisonReport_internal_only', next_implementation_step: 'Wire real upstream comparison report producer and independently validate report-proof linkage' },
  { artefact_id: 'same_video_repeatability_trace', category: 'comparison', expected_path: 'comparison_traces/same_video_repeatability_trace.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitComparisonRuntimeArtifacts', expected_source_of_truth: 'executed repeatability routine', current_manifest_status: 'missing', source_classification: 'internal_comparison_trace', runtime_data_available_now: 'unknown', can_emit_without_invention: false, required_for_level: 'L2', blocker_code: 'SameVideoRepeatability_internal_only', next_implementation_step: 'Require real repeatability diagnostics and independent GF-01/RT-15 proof linkage' },
  { artefact_id: 'comparison_suppression_trace', category: 'comparison', expected_path: 'comparison_traces/comparison_suppression_trace.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitComparisonRuntimeArtifacts', expected_source_of_truth: 'executed suppression evaluator', current_manifest_status: 'missing', source_classification: 'internal_comparison_trace', runtime_data_available_now: 'unknown', can_emit_without_invention: false, required_for_level: 'L2', blocker_code: 'ComparisonSuppression_internal_only', next_implementation_step: 'Require real suppression diagnostics and independent false-winner prevention proof linkage' },
  { artefact_id: 'route_variance_trace', category: 'comparison', expected_path: 'comparison_traces/route_variance_trace.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitComparisonRuntimeArtifacts', expected_source_of_truth: 'executed route variance evaluator', current_manifest_status: 'missing', source_classification: 'internal_comparison_trace', runtime_data_available_now: 'unknown', can_emit_without_invention: false, required_for_level: 'L2', blocker_code: 'RouteVariance_internal_only', next_implementation_step: 'Require real route-variance diagnostics and independent mitigation proof linkage' },
  { artefact_id: 'parity_report', category: 'parity_export', expected_path: 'parity/report_parity_result.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitReportParityProof + emitQAManifestForAnalysisRun', expected_source_of_truth: 'raw/render/public report parity validator runtime', current_manifest_status: 'emitted', source_classification: 'internal_report_parity_proof', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted only from raw/render/public parity checks; do not accept Level 2 from physical emission alone' },
  ...
  { artefact_id: 'no_export_proof', category: 'parity_export', expected_path: 'export_or_no_export/no_export_proof.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitNoExportProofBundle', expected_source_of_truth: 'proof bundle writer after all four component proofs', current_manifest_status: 'emitted', source_classification: 'internal_no_export_proof_bundle', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted as an internal no-export proof bundle; do not enable export/share/download' },
  { artefact_id: 'no_export_source_proof', category: 'parity_export', expected_path: 'export_or_no_export/no_export_source_proof.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitNoExportProofBundle', expected_source_of_truth: 'source proof producer', current_manifest_status: 'emitted', source_classification: 'internal_no_export_source_proof', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted from source boundary inspection and preserve fail-closed diagnostics' },
  { artefact_id: 'no_export_config_proof', category: 'parity_export', expected_path: 'export_or_no_export/no_export_config_proof.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitNoExportProofBundle', expected_source_of_truth: 'config proof producer', current_manifest_status: 'emitted', source_classification: 'internal_no_export_config_proof', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted from configuration boundary inspection and preserve fail-closed diagnostics' },
  { artefact_id: 'no_export_ui_proof', category: 'parity_export', expected_path: 'export_or_no_export/no_export_ui_proof.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitNoExportProofBundle', expected_source_of_truth: 'UI proof producer', current_manifest_status: 'emitted', source_classification: 'internal_no_export_ui_proof', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted from UI boundary inspection and preserve fail-closed diagnostics' },
  { artefact_id: 'no_export_log_proof', category: 'parity_export', expected_path: 'export_or_no_export/no_export_log_proof.json', current_source_module: 'src/server/v3/qa-artifacts-wiring.server.ts emitNoExportProofBundle', expected_source_of_truth: 'log proof producer', current_manifest_status: 'emitted', source_classification: 'internal_no_export_log_proof', runtime_data_available_now: true, can_emit_without_invention: true, required_for_level: 'L2', next_implementation_step: 'Keep emitted from runtime log/export-suppression evidence and preserve fail-closed diagnostics' },
];
...
export function assertRuntimeEvidenceSpineInventoryComplete(): { ok: true; count: number } {
  ...
  if (ids.length !== 27) throw new Error(`runtime_evidence_spine_inventory_count_invalid:${ids.length}`);
