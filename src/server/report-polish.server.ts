...
- If role, character, production, scene, song, copy, routine or known material context is supplied or confidently resolved, populate role_material_context with source_basis, source_summary, primary_standard, secondary_context, demands, confidence and uncertainty_notes. Supplied brief remains primary; known-material or official-source context is secondary nuance only unless the supplied brief or uploaded material explicitly makes it a requirement. Do not use role/material research to invent mandatory blockers, appearance/type/castability/marketability language, callback/recall likelihood or booking/employment predictions.
