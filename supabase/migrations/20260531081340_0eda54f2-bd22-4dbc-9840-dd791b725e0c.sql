...
BEGIN
  ...
  INSERT INTO public.crm_contacts (
    ...
    jsonb_build_object('source','account_compliance_sync','policy_versions',
      jsonb_build_object('terms', compliance.terms_version, 'privacy', compliance.privacy_version,
...
BEGIN PERFORM public.sync_crm_contact_from_account_compliance(NEW.user_id); RETURN NEW; END;
$$;
