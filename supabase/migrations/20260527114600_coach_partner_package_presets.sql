-- DS-09: Coach pilot package presets.
--
-- This extends the DS-08 package catalogue foundation to coach-funded
-- monthly pilots only. Public landing pages, full dashboards/admin UI and
-- runtime credit reservation are owned by later DS slices.
