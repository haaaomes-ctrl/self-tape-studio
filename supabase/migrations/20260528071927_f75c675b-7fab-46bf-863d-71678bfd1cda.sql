...
VALUES
  ('school-pilot-term-gbp-500', 'School Pilot',
   'Term pilot for up to 25 students, with 12 TapeCoach credits per student.',
   'pilot', 'school', 'school_mt_college_pilot', 'term', 'GBP',
   50000, 25, 12, 300, 12, 'term', 'named_progress', TRUE, 10,
   jsonb_build_object('launch_package', true)),
  ('school-growth-term-gbp-1000', 'School Growth',
   'Term growth package for up to 60 students, with 12 TapeCoach credits per student.',
   'growth', 'school', 'school_mt_college_pilot', 'term', 'GBP',
   100000, 60, 12, 720, 12, 'term', 'named_progress', TRUE, 20,
   jsonb_build_object('launch_package', true))
