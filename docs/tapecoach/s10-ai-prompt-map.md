...
Repair is triggered for `missing`, `thin`, `generic`, `contradictory` and `unsupported` modules. `not_assessable` is allowed only when the report explains the limitation, affected evidence and useful next recording/check action.

## Module Coverage Table

| Report module                        | AI question                                                                                                                                | Structured output field                                                                                                                                     | Route/PDF destination                                                                    | Completeness rule                              | Repair prompt         |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------- | --------------------- |
| take slot/version context            | Which take slot and active take version is being analysed or compared, and is any comparison stale or historical?                          | `take_lifecycle`, `take_metadata`, `comparison_context`                                                                                                     | Take badge, comparison context and admin/report identity                                 | complete                                       | missing repair        |
| scoring basis                        | Is this brief_supplied, partial_brief_supplied, no_brief_baseline or brief_uncertain, and what score claims are allowed?                   | `mode` (brief/baseline compatibility), `scoring_context`, `readiness_score_judgement.score_explanation`                                                     | `score_summary`, `submission_guidance`                                                   | complete                                       | contradictory repair  |
| overall readiness                    | After brief achievement is known, what readiness decision and score should the performer see?                                              | `readiness_score_judgement`, `overall_score`, `casting_headline`, `submission_verdict`                                                                      | `readiness_header`                                                                       | complete                                       | contradictory repair  |
| score/chip                           | What score band and score-to-language explanation matches verified brief achievement?                                                      | `readiness_score_judgement`, `overall_score`, `scores`, `category_rationale`                                                                                | `score_summary`                                                                          | complete                                       | contradictory repair  |
| verdict                              | Should the performer submit, review carefully, submit only if deadline is close, or retake if possible?                                    | `readiness_score_judgement`, `verdict_final`, `casting_insight`, `at_risk`                                                                                  | `submission_guidance`                                                                    | complete                                       | contradictory repair  |
| performer level calibration          | What selected-level standard is being applied, what meets it, what falls short and how does level affect recommendation?                   | `readiness_score_judgement.selected_level_calibration`, `readiness_score_judgement.selected_level_calibration_summary`, `scoring_context.level_calibration` | `readiness_header`, `selected_level_calibration`, `submission_guidance`, `score_summary` | complete                                       | thin repair           |
| brief intelligence                   | What useful brief context and explicit requirements should be preserved before the tape is judged?                                         | `brief_context`, `brief_requirements`                                                                                                                       | `brief_context`, `brief_requirements`                                                    | complete                                       | missing repair        |
| brief context                        | Which supplied project, role, material, deadline, upload and package details are useful to show?                                           | `brief_context`                                                                                                                                             | `brief_context`                                                                          | complete                                       | unsupported repair    |
| brief requirements                   | For every supplied requirement, what is mandatory, preferred, optional or ambiguous, and what evidence proves it?                          | `brief_requirements`                                                                                                                                        | `brief_requirements`                                                                     | complete                                       | missing repair        |
| observed tape                        | What actually appears in the tape, in sequence, with component status, assessability and timing where supported?                           | `observed_tape_sequence`, `component_verifications`, `media_observation_summary`                                                                            | `observed_tape`                                                                          | complete                                       | unsupported repair    |
| component breakdown                  | Which components were actually observed, and are they present, absent, partial, cut off, uncertain or not assessable?                      | `observed_tape_sequence`, `component_verifications`, `media_observation_summary`, `detected_components`                                                     | `component_breakdown`                                                                    | complete                                       | unsupported repair    |
| brief achievement                    | For every requirement, what was achieved, mostly achieved, partly achieved, missed, final-check-only or not assessable?                    | `brief_achievement_matrix`, `brief_adherence_breakdown`, `submission_risk_flags`                                                                            | `brief_achievement`                                                                      | complete                                       | contradictory repair  |
| brief adherence/material compliance  | How does verified brief completion affect visible readiness score, category score and submission language?                                 | `readiness_score_judgement.brief_completion_score`, `readiness_score_judgement.brief_completion_summary`                                                    | `brief_adherence_material_compliance`                                                    | complete                                       | contradictory repair  |
| prioritised fixes                    | What are the most submission-impactful fixes, ordered by urgency and source category?                                                      | `s10_fix_hierarchy.priority_fixes`, `priority_fixes`                                                                                                        | `fix_hierarchy`                                                                          | complete                                       | thin repair           |
| fix-first                            | What is the single first action before submitting or retaking?                                                                             | `s10_fix_hierarchy.fix_first`, `fix_first`                                                                                                                  | `fix_hierarchy`                                                                          | complete                                       | generic repair        |
| why this score                       | For each visible score, what works, why is it not full score, and what closes the gap?                                                     | `readiness_score_judgement.category_rationale`, `category_rationale`                                                                                        | `category_rationale`                                                                     | complete                                       | thin repair           |
| category scores                      | How should technical, audio, vocal, acting, brief adherence and presentation be scored after component verification?                       | `readiness_score_judgement.category_scores`, `scores`, `category_notes`                                                                                     | `category_scores`                                                                        | complete                                       | contradictory repair  |
| strengths                            | What specific strengths are supported by verified S10 component evidence?                                                                  | `s10_professional_critique`, `strengths`                                                                                                                    | `strengths_and_preserve`                                                                 | complete                                       | generic repair        |
| professional critique                | What professional judgement, strengths, preserve guidance, do-not-overfix notes and limitations are grounded in evidence?                  | `s10_professional_critique`                                                                                                                                 | `professional_critique`, `strengths_and_preserve`                                        | complete                                       | generic repair        |
| preserve / do-not-overfix            | What should be preserved, and what should not be over-fixed?                                                                               | `s10_professional_critique`, `s10_fix_hierarchy`, `s10_next_action_plan`                                                                                    | `strengths_and_preserve`, `fix_hierarchy`, `next_action_plan`                            | thin allowed only if not assessable            | thin repair           |
| improvements                         | What concrete improvements are grounded in the observed tape and selected level?                                                           | `s10_fix_hierarchy.should_improve_if_retaking`, `improvements`                                                                                              | `fix_hierarchy`                                                                          | complete                                       | generic repair        |
| technique commentary                 | What acting, vocal, movement, MT package or presentation technique commentary is visible, and what is not assessable?                      | `s10_technique_commentary`, `category_rationale`, `category_notes`, `improvements`                                                                          | `technique_commentary`                                                                   | thin allowed only with limitation              | not-assessable repair |
| timestamped notes                    | What timestamped or time-banded moments evidence strengths, fixes, missing components, cut-offs or technical observations?                 | `s10_timestamped_commentary`, `timestamped_notes`                                                                                                           | `timestamped_commentary`                                                                 | thin allowed when exact timestamps unavailable | missing repair        |
| next action                          | What finite next-take plan, submit checklist or review checklist should the performer follow?                                              | `s10_next_action_plan`, `next_take_plan`, `coaching_drills`                                                                                                 | `next_action_plan`                                                                       | complete                                       | generic repair        |
| submission risk                      | Which brief, package, technical, admin or uncertainty issues could block or reduce readiness?                                              | `submission_risk_flags`, `casting_risk_explanations`, `at_risk`                                                                                             | `submission_risk`                                                                        | complete                                       | contradictory repair  |
| role/material context                | Where role, character, production or material context is supplied or resolved, what source basis and demands may inform the report?        | `role_material_context`, `role_fit_notes`, `role_fit_modifier`, `role_fit_confidence`                                                                       | `brief_context`, `submission_risk`, `technique_commentary`                               | not_assessable allowed                         | not-assessable repair |
| role fit                             | Where brief context is sufficient, how does performance serve role function and tone without castability or type language?                 | `role_fit_notes`, `role_fit_modifier`, `role_fit_confidence`                                                                                                | role/material context block where present                                                | not_assessable allowed                         | not-assessable repair |
| professional competitive calibration | For Professional assessable tapes scoring 90+, which 90-100 zone applies, why, what suppresses next zone and what retake strategy follows? | `professional_competitive_calibration`, `readiness_score_judgement.professional_nuance_summary`, `s10_professional_critique`                                | `score_summary`, `professional_critique`, `strengths_and_preserve`                       | complete                                       | thin repair           |
| comparison                           | When comparison is enabled, which active take versions were compared, is the comparison valid, and what does or does not separate them?    | `s10_comparison_truth`, `comparison_truth`, `comparison_context`                                                                                            | `comparison_truth`                                                                       | complete                                       | contradictory repair  |
| same-video status                    | Do compared or replaced takes appear to use the same underlying media, and what caution or operator confirmation is needed?                | `s10_same_video_evidence`, `same_video_status`                                                                                                              | `same_video_status`                                                                      | complete                                       | unsupported repair    |
| presentation notes                   | What practical presentation notes are supported by camera/audio evidence?                                                                  | `s10_professional_critique.professional_presentation_notes`, `s10_technique_commentary.self_tape_presentation`, `presentation_notes`                        | `presentation_notes`                                                                     | thin allowed                                   | unsupported repair    |
| not-assessable limitations           | What cannot be assessed, what is affected, and what check resolves it?                                                                     | `confidence_reason`, `s10_view_model.limitations`, `category_notes`, `improvements`                                                                         | `limitations`                                                                            | not_assessable                                 | not-assessable repair |
| diagnostic chips                     | No performer-facing AI judgement should populate diagnostic chips; if chips are shown, what structured diagnostic source authorises them?  | `diagnostic_chips`, QA/admin diagnostics                                                                                                                    | `diagnostic_chips`                                                                       | not_assessable                                 | unsupported repair    |
